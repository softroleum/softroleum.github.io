const imgAPI = {
  ...
  agency: [
    '/images/services/img09.png',
    '/images/services/img10.png',
    '/images/services/img11.png',
    '/images/services/img12.png',
    '/images/services/img13.png',
    '/images/services/img11.png',
    '/images/services/img14.png',
    '/images/services/img15.png',
    '/images/services/img16.png',
    '/images/services/img17.png',
